...
public class SheetLayoutCustom extends FrameLayout {
    ...
    public SheetLayoutCustom(Context context) {
        super(context);
        init();
    }

    public SheetLayoutCustom(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
        loadAttributes(context, attrs);
    }

    public SheetLayoutCustom(Context context, AttributeSet attrs, int defStyle) {
